...
def main():
    ...
    for i in range(n):
        ...
        feature_names.extend(["T_max_" + str(n - i), "T_min_" + str(n - i), "T_śr_" + str(n - i)])
    ...
    plt.savefig('./Wykresy/LR_TMP'+str(n)+'.png', format='png')
    ...
    plt.savefig('./Wykresy/LR_TMP_'+str(n)+'days.png', format='png')
    plt.close()
